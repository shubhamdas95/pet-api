Feature: Testing a REST API
  ...
  Scenario: Data Upload to a web service
    ...
    Scenario: Data Update to a web service
    When users update data on a project
    Then the server should handle it and return a success status

  Scenario: Data retrieval from pet web service
    When users want to get information on the 'available' pets
    Then the requested data is returned
    
  Scenario: Delete Data  from pet web service
